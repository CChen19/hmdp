-- Flyway V1 baseline: schema only (matches hmdp.sql table definitions).
-- Seed / full dump with data remains in repository root hmdp.sql.
-- Existing local DBs: spring.flyway.baseline-on-migrate=true skips re-applying V1.
